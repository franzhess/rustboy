...
pub fn execute(op_code: u8, cpu: &mut Cpu) -> OpCodeResult {
    match op_code {
        ...
        0x01 => {
            cpu.execute(alu::rlc, RegisterName8::C);
            Executed(8)
        } //RLC C
        0x02 => {
            cpu.execute(alu::rlc, RegisterName8::D);
            Executed(8)
        } //RLC D
        0x03 => {
            cpu.execute(alu::rlc, RegisterName8::E);
            Executed(8)
        } //RLC E
        0x04 => {
            cpu.execute(alu::rlc, RegisterName8::H);
            Executed(8)
        } //RLC H
        0x05 => {
            cpu.execute(alu::rlc, RegisterName8::L);
            Executed(8)
        } //RLC L
        0x06 => {
        ...
        0x08 => {
            cpu.execute(alu::rrc, RegisterName8::B);
            Executed(8)
        } //RRC B
        0x09 => {
            cpu.execute(alu::rrc, RegisterName8::C);
            Executed(8)
        } //RRC C
        0x0A => {
            cpu.execute(alu::rrc, RegisterName8::D);
            Executed(8)
        } //RRC D
        0x0B => {
            cpu.execute(alu::rrc, RegisterName8::E);
            Executed(8)
        } //RRC E
        0x0C => {
            cpu.execute(alu::rrc, RegisterName8::H);
            Executed(8)
        } //RRC H
        0x0D => {
            cpu.execute(alu::rrc, RegisterName8::L);
            Executed(8)
        } //RRC L
        0x0E => {
        ...
        0x10 => {
            cpu.execute(alu::rl, RegisterName8::B);
            Executed(8)
        } //RL B
        0x11 => {
            cpu.execute(alu::rl, RegisterName8::C);
            Executed(8)
        } //RL C
        0x12 => {
            cpu.execute(alu::rl, RegisterName8::D);
            Executed(8)
        } //RL D
        0x13 => {
            cpu.execute(alu::rl, RegisterName8::E);
            Executed(8)
        } //RL E
        0x14 => {
            cpu.execute(alu::rl, RegisterName8::H);
            Executed(8)
        } //RL H
        0x15 => {
            cpu.execute(alu::rl, RegisterName8::L);
            Executed(8)
        } //RL L
        0x16 => {
        ...
        0x18 => {
            cpu.execute(alu::rr, RegisterName8::B);
            Executed(8)
        } //RR B
        0x19 => {
            cpu.execute(alu::rr, RegisterName8::C);
            Executed(8)
        } //RR C
        0x1A => {
            cpu.execute(alu::rr, RegisterName8::D);
            Executed(8)
        } //RR D
        0x1B => {
            cpu.execute(alu::rr, RegisterName8::E);
            Executed(8)
        } //RR E
        0x1C => {
            cpu.execute(alu::rr, RegisterName8::H);
            Executed(8)
        } //RR H
        0x1D => {
            cpu.execute(alu::rr, RegisterName8::L);
            Executed(8)
        } //RR L
        0x1E => {
        ...
        0x20 => {
            cpu.execute(alu::sla, RegisterName8::B);
            Executed(8)
        } //SLA B
        0x21 => {
            cpu.execute(alu::sla, RegisterName8::C);
            Executed(8)
        } //SLA C
        0x22 => {
            cpu.execute(alu::sla, RegisterName8::D);
            Executed(8)
        } //SLA D
        0x23 => {
            cpu.execute(alu::sla, RegisterName8::E);
            Executed(8)
        } //SLA E
        0x24 => {
            cpu.execute(alu::sla, RegisterName8::H);
            Executed(8)
        } //SLA H
        0x25 => {
            cpu.execute(alu::sla, RegisterName8::L);
            Executed(8)
        } //SLA L
        0x26 => {
        ...
        0x28 => {
            cpu.execute(alu::sra, RegisterName8::B);
            Executed(8)
        } //SRA B
        0x29 => {
            cpu.execute(alu::sra, RegisterName8::C);
            Executed(8)
        } //SRA C
        0x2A => {
            cpu.execute(alu::sra, RegisterName8::D);
            Executed(8)
        } //SRA D
        0x2B => {
            cpu.execute(alu::sra, RegisterName8::E);
            Executed(8)
        } //SRA E
        0x2C => {
            cpu.execute(alu::sra, RegisterName8::H);
            Executed(8)
        } //SRA H
        0x2D => {
            cpu.execute(alu::sra, RegisterName8::L);
            Executed(8)
        } //SRA L
        0x2E => {
        ...
        0x30 => {
            cpu.execute(alu::swap, RegisterName8::B);
            Executed(8)
        } //SWAP B
        0x31 => {
            cpu.execute(alu::swap, RegisterName8::C);
            Executed(8)
        } //SWAP C
        0x32 => {
            cpu.execute(alu::swap, RegisterName8::D);
            Executed(8)
        } //SWAP D
        0x33 => {
            cpu.execute(alu::swap, RegisterName8::E);
            Executed(8)
        } //SWAP E
        0x34 => {
            cpu.execute(alu::swap, RegisterName8::H);
            Executed(8)
        } //SWAP H
        0x35 => {
            cpu.execute(alu::swap, RegisterName8::L);
            Executed(8)
        } //SWAP L
        0x36 => {
        ...
        0x38 => {
            cpu.execute(alu::srl, RegisterName8::B);
            Executed(8)
        } //SRL B
        0x39 => {
            cpu.execute(alu::srl, RegisterName8::C);
            Executed(8)
        } //SRL C
        0x3A => {
            cpu.execute(alu::srl, RegisterName8::D);
            Executed(8)
        } //SRL D
        0x3B => {
            cpu.execute(alu::srl, RegisterName8::E);
            Executed(8)
        } //SRL E
        0x3C => {
            cpu.execute(alu::srl, RegisterName8::H);
            Executed(8)
        } //SRL H
        0x3D => {
            cpu.execute(alu::srl, RegisterName8::L);
            Executed(8)
        } //SRL L
        0x3E => {
        ...
        _ => {
            cpu.halted = true;
            Executed(4)
        } //unreachable, but linux compiler will complain
    }
}
