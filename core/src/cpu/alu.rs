...
pub fn adc(flag_register: &mut dyn FlagRegister, value1: u8, value2: u8) -> u8 { //like add + carry flag
...
pub fn add_next_signed_byte_to_word(flag_register: &mut dyn FlagRegister, value1: u16, value2: u16) -> u16 {
  flag_register.reset_flags();
...
pub fn daa(flag_register: &mut dyn FlagRegister, value: u8) -> u8 {  //i got no idea what i'm doing
...
fn shift_operation_flag_update_without_z(flag_register: &mut dyn FlagRegister, _result:u8, new_carry: bool) {
  flag_register.reset_flags();
...
fn rotate_left_through_carry(flag_register: &mut dyn FlagRegister, value: u8, flag_update_function: fn(&mut dyn FlagRegister, u8, bool)) -> u8 {
...
pub fn rl(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //rotate left through carry
...
pub fn rla(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //rotate left through carry
  rotate_left_through_carry(flag_register, value, shift_operation_flag_update_without_z)
}

fn rotate_left(flag_register: &mut dyn FlagRegister, value: u8, flag_update_function: fn(&mut dyn FlagRegister, u8, bool)) -> u8 {
  let new_carry = (value & 0x80) == 0x80; //left most bit that gets pushed out
...
pub fn rlc(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //rotate left
  rotate_left(flag_register, value, shift_operation_flag_update)
}

pub fn rlca(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //rotate left
  rotate_left(flag_register, value, shift_operation_flag_update_without_z)
}

fn rotate_right_through_carry(flag_register: &mut dyn FlagRegister, value: u8, flag_update_function: fn(&mut dyn FlagRegister, u8, bool)) -> u8 {
...
pub fn rr(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //rotate right through carry
  rotate_right_through_carry(flag_register, value, shift_operation_flag_update)
}

pub fn rra(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //rotate right through carry
  rotate_right_through_carry(flag_register, value, shift_operation_flag_update_without_z)
}

fn rotate_right(flag_register: &mut dyn FlagRegister, value: u8, flag_update_function: fn(&mut dyn FlagRegister, u8, bool)) -> u8 {
  let new_carry = (value & 0x01) == 0x01;
...
pub fn rrc(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //rotate right
  rotate_right(flag_register, value, shift_operation_flag_update)
}

pub fn rrca(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //rotate right
...
pub fn sla(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //shift left arithmetic (b0=0)
...
pub fn sra(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //shift left arithmetic (b0=0)
  let new_carry = (value & 0x01) == 0x01;
...
pub fn srl(flag_register: &mut dyn FlagRegister, value: u8) -> u8 { //shift left arithmetic (b0=0)
  let new_carry = (value & 0x01) == 0x01;
  let result = value >> 1;
  shift_operation_flag_update(flag_register, result, new_carry);
  result
...
pub fn ccf(flag_register: &mut dyn FlagRegister) { //compliment carry flag
  flag_register.set_flag(CpuFlag::N, false);
  flag_register.set_flag(CpuFlag::H, false);
  flag_register.set_flag(CpuFlag::C, !flag_register.get_flag(CpuFlag::C));
}

pub fn scf(flag_register: &mut dyn FlagRegister) { //set carry flag
  flag_register.set_flag(CpuFlag::N, false);
  flag_register.set_flag(CpuFlag::H, false);
  flag_register.set_flag(CpuFlag::C, true);
}

pub fn bit(flag_register: &mut dyn FlagRegister, bit: u8, value: u8) { //check bit at
